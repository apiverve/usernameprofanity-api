# Username Profanity Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:usernameprofanity-api:1.1.14'
}
```
...
```java
import com.apiverve.usernameprofanity.UsernameProfanityAPIClient;
import com.apiverve.usernameprofanity.APIResponse;
import com.apiverve.usernameprofanity.APIException;

// Initialize the client
UsernameProfanityAPIClient client = new UsernameProfanityAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("username", "b00bs");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/usernameprofanity](https://docs.apiverve.com/ref/usernameprofanity)
...
- **Documentation:** [https://docs.apiverve.com/ref/usernameprofanity](https://docs.apiverve.com/ref/usernameprofanity)
- **Issues:** [GitHub Issues](https://github.com/apiverve/usernameprofanity-api/issues)
