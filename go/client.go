// Package usernameprofanity provides a Go client for the Username Profanity API.
//
// For more information, visit: https://usernameprofanity.apiverve.com?utm_source=go&utm_medium=readme
package usernameprofanity
...
const (
	baseURL        = "https://api.apiverve.com/v1/usernameprofanity"
	defaultTimeout = 30 * time.Second
)

// Client is the Username Profanity API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Username Profanity API client.
...
// Execute makes a request to the Username Profanity API with typed parameters.
//
...
//   - username (required): string - The username to check if it is inappropriate or profane
