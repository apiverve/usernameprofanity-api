...
namespace APIVerve.API.UsernameProfanity
{
    ...
    /// <summary>
    /// Client for the UsernameProfanity API
    /// </summary>
    public class UsernameProfanityAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/usernameprofanity";
        ...
        {
            { "username", new ValidationRule { Type = "string", Required = true } }
        };
        ...
        public UsernameProfanityAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public UsernameProfanityAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public UsernameProfanityAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, UsernameProfanityQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(UsernameProfanityQueryOptions options)
        {
        ...
        public ResponseObj Execute(UsernameProfanityQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(UsernameProfanityQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(UsernameProfanityQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(UsernameProfanityQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(UsernameProfanityQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(UsernameProfanityQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(UsernameProfanityQueryOptions options)
        {
