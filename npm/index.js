...
class usernameprofanityWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/usernameprofanity');
        }
        ...
        this.validationRules = {"username":{"type":"string","required":true}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/usernameprofanity`);
        }
    }
...
module.exports = usernameprofanityWrapper;
